...
def page(title,body,u=None):
 nav=f'<nav><div class="logo">Insight<b>Dash</b></div><div>'+(f'<a href="/dashboard">Visão geral</a> &nbsp; <a href="/upload">Importar</a> &nbsp; <a href="/logout">Sair</a>' if u else '<a href="/login">Entrar</a> &nbsp; <a class="btn" href="/register">Começar</a>')+'</div></nav>'nav=f'<nav><a href="/" class="logo">Insight<b>Dash</b></a><div>'+(f'<a href="/dashboard">Visão geral</a> &nbsp; <a href="/upload">Importar</a> &nbsp; <a href="/logout">Sair</a>' if u else '<a href="/login">Entrar</a> &nbsp; <a class="btn" href="/register">Começar</a>')+'</div></nav>'
